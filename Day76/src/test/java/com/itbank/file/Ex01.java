...
public class Ex01 {
	...
	public void test1() {
		...
		// 자바에서는 파일을 처리하기 위해 클래스로 제공 중
		// - 생성자에 파일의 경로를 문자열로 지정 가능
		// - 1. 상대경로는 프로젝트(Day76) 바로 아래가 된다
		// - 2. 절대경로는 c: d: 같은 드라이브부터 경로를 명시한다
		File dir1 = new File("FileFolder");		// 상대경로
		File dir2 = new File("E:\\FileFolder"); // 절대경로
		
		// exist : 지정 파일이 있으면 true, 없으면 false
