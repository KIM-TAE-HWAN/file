...
<body>
	...
	<ol>
		...
		<li>단, 학생 정보는 beans.Student를 활용해서 받는다</li>
	</ol>
	
	
	<form action="ex05_result.jsp" method="POST">
		<p><input name="name" placeholder="이름" required></p>
		<p><input name="kor" type="number" placeholder="국" required></p>
		<p><input name="eng" type="number" placeholder="영" required></p>
		<p><input name="mat" type="number" placeholder="수" required></p>	
